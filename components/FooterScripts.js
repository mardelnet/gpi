...
const WP_INCLUDES_URL = `${BASE_URL}/wp-includes/js/dist`;
...
const SCRIPTS = [
    ...
    { src: `${WP_INCLUDES_URL}/vendor/react.min.js`, id: "react-js" },
    { src: `${WP_INCLUDES_URL}/vendor/react-dom.min.js`, id: "react-dom-js" },
    { src: `${WP_INCLUDES_URL}/escape-html.min.js`, id: "wp-escape-html-js" },
    { src: `${WP_INCLUDES_URL}/element.min.js`, id: "wp-element-js" },
    { src: `${WP_INCLUDES_URL}/hooks.min.js`, id: "wp-hooks-js" },
    { src: `${WP_INCLUDES_URL}/i18n.min.js`, id: "wp-i18n-js" },
    { src: `${WP_INCLUDES_URL}/dom-ready.min.js`, id: "wp-dom-ready-js" },
    { src: `${WP_INCLUDES_URL}/a11y.min.js`, id: "wp-a11y-js" },
